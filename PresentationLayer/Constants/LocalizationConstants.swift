...
struct LocalizationConstants {
    ...
    static let signInButtonText = R.string.localizable.sign_in_button_text()
    static let signUpButtonText = R.string.localizable.sign_up_button_text()
    
    // MARK: - ONBOARDING
    
    // General

    static let getStartedButtonText = R.string.localizable.get_started_button_text()
    
    // Walkthrough 1
    
    static let firstScreenTitle = R.string.localizable.first_screen_title()
    static let firstScreenMessage = R.string.localizable.first_screen_message()
    
    // Walkthrough 2
    
    static let secondScreenTitle = R.string.localizable.second_screen_title()
    static let secondScreenMessage = R.string.localizable.second_screen_message()
